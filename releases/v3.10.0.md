...
- Admin API and AgentStudio integrations
...
**Full Changelog**: https://github.com/XiansAiPlatform/community-edition/compare/vPREVIOUS...v3.10.0
**Docker Images**: Available with tag `v3.10.0`
