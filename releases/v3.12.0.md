...
- File uploads
- Tool and Reasoning progress

### 🐛 Bug Fixes

- TenantId issues in Knowledge and Logs fixed
...
**Full Changelog**: https://github.com/XiansAiPlatform/community-edition/compare/vPREVIOUS...v3.12.0
**Docker Images**: Available with tag `v3.12.0`
