...
OPTIONS:
    ...
    --assets-repos      Comma-separated list of repos to download assets from
                        (default: XiansAiPlatform/XiansAi.Server,XiansAiPlatform/XiansAi.Lib,XiansAiPlatform/XiansAi.Otel.Lib,XiansAiPlatform/sdk-web-typescript)
...
main() {
    ...
    ASSETS_REPOS="XiansAiPlatform/XiansAi.Server,XiansAiPlatform/XiansAi.Lib,XiansAiPlatform/XiansAi.Otel.Lib,XiansAiPlatform/sdk-web-typescript"
